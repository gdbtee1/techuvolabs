        ...
        <div className="mt-20 grid lg:grid-cols-[0.9fr_1.1fr] gap-6">
          <div className="rounded-[2rem] bg-gradient-to-br from-orange-100 via-pink-100 to-purple-100 p-6 md:p-8 shadow-xl border border-white">
            ...
            <p className="mt-4 text-slate-600 leading-relaxed">
              The goal is not just to make software look good.
              The goal is to build tools that help businesses save time
              close leads collect payments organize work and create
          ...
          <div className="rounded-[2rem] bg-white p-6 md:p-8 shadow-xl border border-pink-100">
            ...
            <p className="mt-4 text-slate-600 leading-relaxed">
              Techuvo Labs is built to support tool subscriptions
              client dashboards payment integrations custom builds
              and future login-based software experiences.
            </p>
          </div>
        </div>
      </div>
